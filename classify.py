...
>>>>>>> 5434acc (Add progress tracking and skipping over previously processed files by default. A restart option should be provided to reset the progressing tracking)
