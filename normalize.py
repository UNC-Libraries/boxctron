...
parser.add_argument('-m', '--max-dimension', type=int, default=1333,
                    help='Maximum length of the longest dimension of the image, if exceeded the image will be resized. Default: 1333'),
parser.add_argument('-M', '--min-dimension', type=int, default=224,
                    help='Minimum length of the shortest dimension of the image, cannot be resized below this. Default: 224'),
